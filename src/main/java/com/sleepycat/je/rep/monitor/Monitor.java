...
public class Monitor {
    ...
    private void notifyJoinGroupEventsForActiveNodes(ReplicationGroup group) {
        ...
        for (ReplicationNode repNode : group.getNodes()) {
            ...
            /*
             * Note any existing non-secondary nodes as group members.
             * Secondary nodes never send add or remove events, so they are not
             * included in groupMembers.
             */
            if (!repNode.getType().isSecondary()) {
